<?php
/**
 * Test the register_clearance_badge_bg_color_setting function.
 *
 * @package WC_Clearance
 */

use function WC_Clearance\register_clearance_badge_bg_color_setting;
use const WC_Clearance\CLEARANCE_BADGE_BG_COLOR_OPTION;

class Test_Register_Clearance_Badge_Bg_Color_Setting extends WP_UnitTestCase {

public function test_registers_clearance_badge_bg_color_setting(): void {
// Arrange.
