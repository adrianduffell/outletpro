...
use function OutletPro\register_outlet_badge_border_style_setting;
...
class Test_Register_Outlet_Badge_Border_Style_Setting extends WP_UnitTestCase {
	...
	public function test_registers_outlet_border_style_setting(): void {
		// Arrange.
		unregister_setting( 'outletpro', OUTLET_BADGE_BORDER_STYLE_OPTION );
