...
function display_clearance_badge_hook(): void {
	...
	printf(
		'<p class="wc-clearance-badge-container"><span class="wc-clearance-badge" style="background-color:%s; color:%s; border-radius:2px; padding:0.35em 0.5em; font-weight:600; font-size:0.875em;">%s</span></p>',
		esc_attr( $bg_colour ),
