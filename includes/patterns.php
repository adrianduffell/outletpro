...
function get_outlet_filter_tiles_content(): string {
	...
	return '<!-- wp:buttons {"spacing":{"margin":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}},"layout":{"type":"flex","justifyContent":"left"},"className":"wc-outlet-filter-tiles"} -->' . "\n" .
		'<div class="wp-block-buttons is-content-justification-left wc-outlet-filter-tiles" style="margin-top:var(--wp--preset--spacing--30);margin-bottom:var(--wp--preset--spacing--30)">' . implode( "\n\n", $buttons ) . '</div>' . "\n" .
		'<!-- /wp:buttons -->';
}
