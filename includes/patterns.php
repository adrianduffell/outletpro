...
function get_outlet_filter_tiles_content(): string {
	...
	return '<!-- wp:group {"layout":{"type":"constrained","justifyContent":"center"},"style":{"spacing":{"margin":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}}} -->' . "\n" .
		'<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--30);margin-bottom:var(--wp--preset--spacing--30)"><!-- wp:buttons {"align":"wide","layout":{"type":"flex","justifyContent":"left","flexWrap":"nowrap"},"className":"wc-outlet-filter-tiles"} -->' . "\n" .
		'<div class="wp-block-buttons alignwide wc-outlet-filter-tiles">' . implode( "\n\n", $buttons ) . '</div>' . "\n" .
		'<!-- /wp:buttons --></div>' . "\n" .
		'<!-- /wp:group -->';
}
