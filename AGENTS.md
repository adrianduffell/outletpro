...
* Guards: Don't add OR conditions in guard clauses. Instead of combining multiple conditions with `||`, write each guard as separate `if` statements to improve readability and debugging.
