...
* Each test is self-contained. TNever use shared `setUp` / `tearDown` or similar variants in PHPUnit. Each test is responsible for arranging the environment to be the exact state it needs.
