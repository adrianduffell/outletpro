...
* Don't cast variables, except in extreme circumstances (in which case the occurrance should be throroughly documented`. It is better to fail fast that co-orce possibly corrupted values and land in a unknown state.
